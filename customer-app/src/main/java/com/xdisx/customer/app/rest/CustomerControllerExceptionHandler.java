...
public class CustomerControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomerCreateException(WebRequest r, CustomerCreateException e) {
        return setResponse(r, e, HttpStatus.BAD_REQUEST);
    }

    private ResponseEntity<Object> setResponse(WebRequest r, CustomerCreateException e, HttpStatus status) {
